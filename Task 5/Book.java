...
public class Book implements Serializable {
    ...
    public void addReservation(String memberId) {
        if (!reservationQueue.contains(memberId)) reservationQueue.addLast(memberId);
    }

    public String peekReservation() {
        return reservationQueue.peekFirst();
    }
    ...
    public String toString() {
        return String.format("[%s] %s — %s | Cat: %s | Available: %d/%d",
